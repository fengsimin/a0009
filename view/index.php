	    ...
	    <div class="swiper-container animated">
	        <div class="swiper-wrapper">
	            ...
	            <div class="swiper-slide" data-hash="slide<?php echo $i;?>">
	                <div class="bg" data-path="<?php echo $image_path;?>" data-image="<?php echo $image;?>" data-utime="<?php echo $utime;?>">
	                    <img data-src="<?php echo $this->url($image_path . '/' . $image, $utime);?>" class="swiper-lazy">
	                    <div class="swiper-lazy-preloader"></div>
	                    <a <?php echo $url ? 'href="' . $url . '"' : '';?> target="<?php echo $item['url_target'];?>" style="<?php echo $item['bgcolor']?'background-color:'.$item['bgcolor']:'rgba(65, 65, 65, 0.9)';?>" class="animated">
	                        <?php if ($item['title']):?>
